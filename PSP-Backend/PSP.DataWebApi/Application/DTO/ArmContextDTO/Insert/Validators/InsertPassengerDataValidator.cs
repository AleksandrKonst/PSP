...
namespace Application.DTO.ArmContextDTO.Insert.Validators;

public class InsertPassengerDataValidator : AbstractValidator<InsertPassengerDataDTO>
{
    public InsertPassengerDataValidator()
    {
        RuleFor(x => x.Surname)
            .MaximumLength(40)
