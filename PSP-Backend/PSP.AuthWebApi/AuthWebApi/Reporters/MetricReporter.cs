...
namespace AuthWebApi.Reporters;
...
public class MetricReporter(ILogger<MetricReporter> logger)
{
        ...
        private readonly Counter _requestCounter = Metrics.CreateCounter("total_requests", "The total number of requests serviced by this API.");
        private readonly Histogram _responseTimeHistogram = Metrics.CreateHistogram("request_duration_seconds",
