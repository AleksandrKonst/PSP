...
public static class UpdatePassengerQuotaCount
{
    ...
    public class Handler(IPassengerQuotaCountRepository repository, IMapper mapper) : IRequestHandler<Command, CommandResult>
    {
        ...
        {
            return new CommandResult(await repository.UpdateAsync(mapper.Map<PassengerQuotaCount>(request.PassengerQuotaCountDto)));
        }
    }
}